              ...
              <View>
                ...
                <View
                  ...
                  <TouchableOpacity onPress={togglePasswordVisibility}>
                    {passwordVisible ? (
                      <EyeSlash variant="Linear" color={'#000000'} size={20} />
                    ) : (
                      <Eye variant="Linear" color={'#000000'} size={20} />
                    )}
                  </TouchableOpacity>
                </View>
              </View>
          ...
          <View style={{gap: 10}}>
            <TouchableHighlight
              style={[
                button.container,
                {
                  backgroundColor: isSignupDisabled ? '#fa8e8e' : '#FF5757',
                },
              ]}
            ...
            <View style={{flexDirection: 'row', gap: 5, alignSelf: 'center'}}>
              ...
              <TouchableOpacity onPress={() => navigation.navigate('Login')}>
                <Text style={[button.label, {color: '#FF5757'}]}>Log in</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
